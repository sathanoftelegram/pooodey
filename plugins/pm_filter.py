...
🌟༺ ──•◈•─ ─•◈•──༻🌟')
            ...
            buttons = [
            [
                InlineKeyboardButton('🌀 Jᴏɪɴ Fᴏʀ Mᴏʀᴇ 🌀', url='https://t.me/CT_Arena')
            ]
            ]
        ...
        buttons = [[
            InlineKeyboardButton('ᴄᴛ ʟɪɴᴋs', url='https://t.me/CT_Arena'),
            InlineKeyboardButton('ᴍᴏᴠɪᴇs', url='https://t.me/joinchat/AxHu-k3fvsZmMDE1'),
